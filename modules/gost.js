...
class GOST {
    ...
    static buffer(d) {
        if (d instanceof ArrayBuffer)
            ...
            throw new DataError('GOST Hashing Error. ArrayBuffer or ArrayBufferView required');
    }
    ...
    digest2012(data, stringOnOutput = true, stringFormat = 'hex') {
        ...
        // Constant C
        let C = (function (s) {
            let h = new Int32Array(GOST.b64decode(s)),
                r = new Array(12);
            for (let i = 0; i < 12; i++)
        ...
        // Precalc Ax
        let Ax = (function (s) {
            return new Int32Array(GOST.b64decode(s));
        })(
