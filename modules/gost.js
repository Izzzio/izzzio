    ...
    digest2012 = (function ()
        {
            ...
            return function (data) {
                ...
                console.log (Buffer.from(digest.buffer).toString('hex'));
...
let s = '123';
let arr = Buffer.from(s);
var d = digest2012(arr);

console.log (Buffer.from(d).toString('hex'));
GOST = require('node-gost');
let a = new GOST.subtle.digest('3411',arr);
a.then(result=>console.log(Buffer.from(result).toString('hex')));
